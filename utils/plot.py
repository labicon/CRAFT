...
CONFIGS = {
    "go2gate": {
        "curriculum_directories": [
            ...
            # "logs/go2gate/08-03_05-36", # Commented out in source
            # "logs/go2gate/08-04_06-19", # Commented out in source
            "logs/go2gate/08-04_17-21",
            # "logs/go2gate/08-05_03-29", # Commented out in source
            # "logs/go2gate/08-05_16-55", # Commented out in source
        ],
        "no_refine_directories": [
            # "logs/go2gate/08-15_00-32_no_refine_1", # Commented out in source
            "logs/go2gate/08-16_05-14_no_refine_2",
            "logs/go2gate/08-16_17-09_no_refine_3",
            # "logs/go2gate/08-17_04-20_no_refine_4", # Commented out in source
            "logs/go2gate/08-17_15-09_no_refine_5",
            # "logs/go2gate/08-18_02-09_no_refine_6" # Commented out in source
        ],
        "scratch_directories": [
            # "checkpoints/go2gate_08-02_01-23_scratch", # Commented out in source
            "checkpoints/go2gate_08-02_12-13_scratch",
            "checkpoints/go2gate_08-02_19-44_scratch",
            # "checkpoints/go2gate_08-03_05-36_scratch", # Commented out in source
            "checkpoints/go2gate_08-04_17-21_scratch",
            # "checkpoints/go2gate_08-05_16-55_scratch", # Commented out in source
        ],
        "example_directories": [
