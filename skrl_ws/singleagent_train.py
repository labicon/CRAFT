...
cfg["experiment"]["directory"] = "runs/torch/go1navigation/singleagent"
cfg["experiment"]["wandb"] = True
now = datetime.now()
cfg["experiment"]["wandb_kwargs"] = {"project": "go1navigation", "name": f"singleagent-{now.strftime('%Y-%m-%d_%H-%M-%S')}"}
